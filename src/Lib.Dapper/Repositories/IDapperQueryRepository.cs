...
namespace Lib.DapperORM.Repositories
{
    public interface IDapperQueryRepository : IDisposable
    {
        ...
        List<TReturn> ListAll<TReturn>([CallerFilePath] string callerFilePath = "", [CallerMemberName] string callerMemberName = "", [CallerLineNumber] int callerLineNumber = -1) where TReturn : class;
        ...
        List<TReturn> List<TReturn>(string query, Action<Builders.QueryParameterBuilder> pBuilder, CommandType commandType = CommandType.Text, [CallerFilePath] string callerFilePath = "", [CallerMemberName] string callerMemberName = "", [CallerLineNumber] int callerLineNumber = -1);
        List<TReturn> List<TReturn>(Action<Builders.QueryBuilder> qBuilder,[CallerFilePath] string callerFilePath = "", [CallerMemberName] string callerMemberName = "", [CallerLineNumber] int callerLineNumber = -1);
        ...
        List<TReturn> List<T1, T2, TReturn>(string query, Func<T1, T2, TReturn> map, string splitColumns, Action<Builders.QueryParameterBuilder> pBuilder, CommandType commandType = CommandType.Text, [CallerFilePath] string callerFilePath = "", [CallerMemberName] string callerMemberName = "", [CallerLineNumber] int callerLineNumber = -1);
        List<TReturn> List<T1, T2, TReturn>(Action<Builders.QueryBuilder> qBuilder, Func<T1, T2, TReturn> map, string splitColumns, [CallerFilePath] string callerFilePath = "", [CallerMemberName] string callerMemberName = "", [CallerLineNumber] int callerLineNumber = -1);
