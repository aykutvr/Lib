...
namespace Lib.DataTablesNet.Builders
{
    ...
    public class EventsBuilder : IHtmlContent
    {
        ...
        {
            events = new Dictionary<string, IList<string>>();
        }
        ...
        private void Add(string key, string parameters, string fn)
        {
            ...
            {
                events.Add(key, new List<string>());
                events[key].Add(parameters);
            }
            events[key].Add(fn);
        }
        ...
        {
            Add("select", "(e,dt,type,indexes)", name);
            return this;
        }
        ...
        {
            Add("deselect", "(e,dt,type,indexes)", name);
            return this;
        }
